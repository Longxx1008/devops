...
exports.getQuality = function(microserid,cb) {
    var sql = " select q.*,s.images_name,s.images_version,a.app_name,a.project_manager,s.first_deploy_time,a.ename," +
        "a.serviceport from pass_project_quality_info q,pass_project_micro_service s,pass_project_app_info a " +
