...
exports.add=function(data,cb){
    var sql="insert into pass_develop_information_info(information_title,information_issuer_id,information_issuer,information_create_time,information_view_count,information_type,information_content,information_picture_name,information_link,information_status,information_picture_type,information_picture) values(?,?,?,?,?,?,?,?,?,?,?,?) ";
...
exports.getInformationManage=function(page, size, data, cb) {
    console.log("-==================-------------"+data);
