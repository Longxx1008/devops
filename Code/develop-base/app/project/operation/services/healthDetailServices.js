...
exports.getHealthDetail=function(conditionMap,cb){
    console.log("testresult",conditionMap);
    var sql='select a.*,b.app_name from pass_project_health_check a left join pass_project_app_info b on a.app_id=b.id where a.id="'+conditionMap.id+'"';
    var conditions={}
