...
var config = {
    project:{
        ...
        template:'app/common/portal/template/',
        url:'',
    ...
    routes:{
        ...
        exclude_auth_check_urls:[project_url_prefix + '/login',project_url_prefix + '/nIndex',project_url_prefix + '/captcha',project_url_prefix + '/test/*', project_url_prefix +'/static/*',project_url_prefix +'/api/project/dpm/interface/*',project_url_prefix +'/api/project/ability/informationBank/develop/info/pageListDemo',project_url_prefix +'/api/project/ability/homePageShow/getCarousel'],
